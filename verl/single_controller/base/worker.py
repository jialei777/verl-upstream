...
class Worker(WorkerHelper):
    ...
    def _setup_env_cuda_visible_devices(self):
        ...
        if is_ray_noset_visible_devices:
            ...
            # Ray only enumerates the accelerators it knows about. Platforms whose devices are not
            # enumerated (e.g. chips selected through a visibility env var) report the local rank
