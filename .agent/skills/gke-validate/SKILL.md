...
> [!IMPORTANT]
> **TPU-Sync (Raiden) Modifications:**
> If `tpu-sync` source code, C++ extensions, or the wheel need to be updated or rebuilt, follow the [`tpu-sync-modify`](../tpu-sync-modify/SKILL.md) skill before running validation on GKE.
